...
export const mockEditorialFiles: Record<string, string> = {
  'knowledge/projects.json': json({ projects: [{ id: 'project-vorschau', title: 'Lokales Vorschauprojekt' }] }),
  'content/portal/topic-coverage.json': json({ asOf: '2026-08-09', discoverability: { minimumActiveHighlights: 1 }, currentStateCoverage: [], projectCoverage: [{ id: 'project-vorschau', topicSlugs: ['vorschau-thema'] }] }),
  ...
  'content/themen/vorschau-thema.json': json({ slug: 'vorschau-thema', title: 'Lokales Vorschauthema', teaser: 'Beispieldatensatz für die Formularprüfung.', status: 'geplant', cluster: 'staat-demokratie', priority: 50, featured: false, updatedAt: '2026-08-09', knowledgeProjectRefs: ['project-vorschau'], beschlossen: [], umgesetzt: [], naechsteSchritte: ['Entwurf prüfen'], rechtsgrundlagen: [], faq: [], federfuehrendesRessort: 'vorschau-ressort' }),
