...
> = {
  ...
  '02': { title: 'Staatskanzlei', category: 'Ressort', responsibility: 'Büro des Staatspräsidenten', politicalFocus: 'Regierungskoordination, strategische Planung und Ehrenamt.', ministrySlug: 'staatskanzlei', ministryLabel: 'Büro des Staatspräsidenten' },
  ...
  '13': { title: 'Staats- und Grenzsicherheit', category: 'Ressort', responsibility: 'Staatssekretariat des Innern und für Staats- und Grenzsicherheit', politicalFocus: 'Polizei, Sicherheit und demokratisch kontrollierte Sicherheitsstrukturen.', ministrySlug: 'inneres-bau-und-kommunale-angelegenheiten', ministryLabel: 'Staatssekretariat des Innern und für Staats- und Grenzsicherheit', topicSlug: 'demokratie-und-sicherheit' },
  '14': { title: 'Land-, Forst- und Küstenwirtschaft', category: 'Ressort', responsibility: 'Staatssekretariat für Nachhaltigkeit, Energie und Land-, Forst- und Küstenwirtschaft', politicalFocus: 'Landwirtschaft, Forsten, Fischerei, Küstenschutz und ländliche Räume.', ministrySlug: 'umwelt-energie-und-klimaschutz', ministryLabel: 'Staatssekretariat für Nachhaltigkeit, Energie und Land-, Forst- und Küstenwirtschaft' },
