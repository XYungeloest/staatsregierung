...
import { getApplicableVersion, validateVersionIntervals } from '@ostrecht/shared/lib/norms/versions.ts';
import { resolveRepositoryRoot } from '@ostrecht/shared/lib/repository-root.ts';

const CONTENT_ROOT = join(resolveRepositoryRoot(), 'content', 'normen');
