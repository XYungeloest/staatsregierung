...
// Ports der lokalen Testserver. Standard 4321/4322 (CI und Einzelarbeitsbaum); mit
// OSTRECHT_PORTAL_PORT und OSTRECHT_LAW_PORT laufen mehrere Arbeitsbäume parallel, ohne
// den Server eines fremden Builds wiederzuverwenden (reuseExistingServer).
