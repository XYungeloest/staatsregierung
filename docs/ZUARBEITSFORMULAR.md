...
sind durch StAnzO. 2026 Nr. 42, OGVBl. 2026 Nr. 75 und die Zuarbeit vom 7. September 2026 belegt.
Mit der Zuarbeit vom 8. September 2026 sind auch die Personenbelege abgeschlossen: Johanna Schwade
führt ein Porträt, die drei Staatssekretäre des Geschäftsbereichs Frieden haben eigene Profile und
ein eigenes Amt unterhalb der Ressortleitung, und die Wikiartikel zu den drei Kabinetten liegen als
datierte Abzüge unter `context/` mit ihren dauerhaften Artikeladressen.

Für Ernennungen von Kabinettmitgliedern gibt es keine amtlichen Dokumente; der transkribierte
