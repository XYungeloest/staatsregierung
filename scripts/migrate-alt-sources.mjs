...
function normMeta({
  ...
  return {
    ...
    // Sachgebiete der amtlichen Systematik; das erste ist zugleich das Hauptsachgebiet.
    subjects,
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Staatliche Organisation', 'Sicherheitsrecht und Polizeirecht'],
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Staatliche Organisation'],
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Vereinsrecht, Versammlungsrecht, Freizügigkeit, Sammlungen', 'Sicherheitsrecht und Polizeirecht'],
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Sicherheitsrecht und Polizeirecht', 'Aus dem Ausland stammende Personen'],
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Sicherheitsrecht und Polizeirecht', 'Rettungsdienst, Katastrophenschutz, Brandschutz, Feuerwehr'],
...
await writeSingleVersionNorm({
  meta: normMeta({
    ...
    subjects: ['Kommunalrecht', 'Raumordnung, Landesplanung'],
