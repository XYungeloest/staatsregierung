...
const NEW_PUBLICATION_CONFIG = {
  ...
  'StAnzO.|2026|42': [{
    slug: 'bekanntmachung-formation-zweiter-staatsrat',
    shortTitle: 'Formation des zweiten Staatsrates',
    type: 'bekanntmachung',
    statusOverride: 'one-time-act',
    pageCount: 2,
    pdfFileName: 'StAnzO. 2026 Nr. 42.pdf',
    verifiedAt: '2026-09-07',
    enactingBody: 'Präsident der Volkskammer des Freistaates Ostdeutschland',
    responsibleMinistry: 'Staatssekretariat für Rechtsstaatlichkeit und kulturelle Emanzipation',
    subjects: ['Staatliche Organisation', 'Verfassungsrecht'],
    keywords: ['Staatsrat', 'Volkskammer', 'Konstituierende Sitzung', 'Karl Honecker', 'Yannik Schmäle', 'Johanna Schwade', 'Tim Dieter'],
    summary: 'Macht bekannt, dass die achte Volkskammer am 7. September 2026 in ihrer konstituierenden Sitzung vier Mitglieder des zweiten Staatsrates gewählt und ihre Geschäftsbereiche bezeichnet hat; die Gewählten wurden vereidigt und ernannt.',
  ...
  'StAnzO.|2026|45': [{
    slug: 'sicherheitserlass-kritis-09-2026',
    shortTitle: 'Sicherheitserlass KRITIS 09/2026',
    type: 'verwaltungsvorschrift',
    pageCount: 5,
    ...
    subjects: ['Sicherheitsrecht und Polizeirecht'],
    keywords: ['Drohnenabwehr', 'Sabotage', 'Objektschutz'],
    summary: 'Regelt vorläufige Schutzmaßnahmen für gefährdete Infrastruktur, besondere Gefährdungsbewertungen für Flughäfen, die Behandlung von Drohnenlagen und ein gemeinsames Lagebild. Polizeiliche Maßnahmen bleiben an bestehende gesetzliche Befugnisse gebunden.',
    effectiveOverride: '2026-09-08',
    expiryDate: '2026-12-08',
    dateNote: 'Am 8. September 2026 bekanntgegeben und in Kraft getreten. Der Erlass tritt nach Nummer 10 mit Ablauf des 8. Dezember 2026 außer Kraft, soweit er nicht zuvor verlängert oder durch dauerhafte Vorschriften ersetzt wird.',
  }],
  'StAnzO.|2026|43': [{
  ...
  'OGVBl.|2026|75': [{
    ...
    type: 'verwaltungsvorschrift',
    pageCount: 10,
    pdfFileName: 'OGVBl. 2026 Nr. 75.pdf',
    verifiedAt: '2026-09-07',
    enactingBody: 'Staatsrat des Freistaates Ostdeutschland',
    responsibleMinistry: 'Büro des Staatspräsidenten',
    subjects: ['Staatliche Organisation', 'Allgemeine Verwaltung'],
    keywords: ['Geschäftsbereich', 'Überfluss', 'Frieden', 'Liebe', 'Wahrheit', 'Staatssekretariat', 'Büro des Staatspräsidenten'],
    summary: 'Grenzt die vier Geschäftsbereiche des zweiten Staatsrates ab, ordnet ihnen zehn Staatssekretariate zu, benennt das Innenressort und das Wirtschaftsressort um, führt Nachhaltigkeit und Energie mit Land-, Forst- und Küstenwirtschaft zusammen, teilt das Ressort für Rechtsstaatlichkeit und kulturelle Emanzipation und stellt das Büro des Staatspräsidenten unmittelbar unter den Staatspräsidenten.',
    effectiveOverride: '2026-09-07',
    relatedNorms: ['staatsverfassung-des-freistaates-ostdeutschland', 'bekanntmachung-formation-zweiter-staatsrat'],
    dateNote: 'Am 7. September 2026 verkündet und nach Abschnitt XII mit der Bekanntmachung in Kraft getreten. Mit dem Inkrafttreten treten entgegenstehende Geschäftsverteilungsbeschlüsse, Organisationsanordnungen und Übergangsregelungen des ersten Staatsrates außer Kraft.',
  }],
  'OGVBl.|2026|69': [{
