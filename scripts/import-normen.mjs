...
const ISSUE_SUBJECTS = {
  ...
  '49': ['Bergbau, Energiewirtschaft, Wasserwirtschaft', 'Gewerbe- und Berufsrecht'],
  '50': ['Sicherheitsrecht und Polizeirecht'],
  '51': ['Öffentlicher Gesundheitsdienst'],
  '52': ['Sport'],
  '53': ['Verfassungsrecht'],
  '54': ['Verfassungsrecht', 'Haushaltwesen, Rechnungshof'],
  '55': ['Verfassungsrecht'],
  '56': ['Verfassungsrecht', 'Bildungswesen'],
  '57': ['Bildungswesen', 'Zivilrecht, Handelsrecht, Urheberrecht, gewerblicher Rechtsschutz'],
...
const NEW_PUBLICATION_CONFIG = {
  ...
  'StAnzO.|2026|33': [{
    ...
    subjects: ['Staatliche Organisation', 'Rettungsdienst, Katastrophenschutz, Brandschutz, Feuerwehr'],
  ...
  'StAnzO.|2026|34': [{
    ...
    subjects: ['Bergbau, Energiewirtschaft, Wasserwirtschaft', 'Gewerbe- und Berufsrecht'],
...
function buildGmblAgreementRecord(parsed) {
  ...
  const meta = {
    ...
    primarySubject: 'Sicherheitsrecht und Polizeirecht',
    keywords: [
      'Verwaltungsabkommen',
      'Grenzpolizei',
      'GMBl. 2026 Nr. 14',
